...
const FormTodo = props => {//Se crea la constante FormTodo como funcion arrow se le pone como parametro props //
  ...
  cambiando que a medida el usuario va a interactuando en ella*/
    const handleSubmit = e => {//Se crea otra funcion que tiene como parametro e de (evento)
        ...
        handleAddItem({/* acá es donde se trae la funcion handleAddItem para que sea un objeto, tiene como clave el valor de falso porque aun no hay un dato escrito, un id donde
